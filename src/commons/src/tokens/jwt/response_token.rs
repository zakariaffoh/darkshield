...
pub struct AuthorizationResponseToken {
    claims: Map<String, Value>,
}

#[allow(dead_code)]
impl AuthorizationResponseToken {
    pub fn new() -> Self {
        Self { claims: Map::new() }
    }
...
impl Jwt for AuthorizationResponseToken {
...
impl Token for AuthorizationResponseToken {
    fn category(&self) -> TokenCategoryEnum {
        TokenCategoryEnum::AuthorizationResponse
    }
}

impl AsRef<Map<String, Value>> for AuthorizationResponseToken {
    fn as_ref(&self) -> &Map<String, Value> {
        &self.claims
    }
}

impl Into<Map<String, Value>> for AuthorizationResponseToken {
    fn into(self) -> Map<String, Value> {
        self.into_map()
    }
}

impl Display for AuthorizationResponseToken {
