...
pub trait IUserService: Interface {
    ...
    async fn load_user_by_id(&self, realm_id: &str, user_id: &str) -> Result<Option<UserModel>, String>;

    async fn load_user_by_ids(&self, realm_id: &str, user_ids: &[&str]) -> Result<Vec<UserModel>, String>;
