...
pub async fn create_user(
    ...
    UserApi::create_user(&context, &realm_id, &user_id, user.0).await
}
...
pub async fn load_users_paging(
    ...
    UserApi::load_users_by_realm_paging(&context, &realm_id, &paging.0).await
}
...
pub async fn load_user_roles_paging(
    ...
    UserApi::load_user_roles(&context, &realm_id, &user_id, &paging.0).await
}
...
pub async fn load_user_groups_paging(
    ...
    UserApi::load_user_groups_paging(&context, &realm_id, &user_id, &paging.0).await
}
...
pub async fn reset_password_email(
    ...
    UserApi::send_reset_password_email(&context, &realm_id, &user_id, &client_id, &redirect_uri)
        .await
}
...
pub async fn send_verify_email(
    ...
    UserApi::send_verify_email(&context, &realm_id, &user_id, &client_id, &redirect_uri).await
}
...
pub async fn impersonate_user(
    ...
    UserApi::impersonate_user(&context, &realm_id, &user_id, &client_id, &scope).await
}
