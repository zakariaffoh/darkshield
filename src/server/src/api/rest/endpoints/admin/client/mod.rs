...
pub async fn create_client(
    ...
    ClientApi::create_client(&session, client_model).await
}
...
pub async fn update_client(
    ...
    ClientApi::update_client(&session, client_model).await
}
...
pub async fn load_client_by_id(
    ...
    ClientApi::load_client_by_id(&session, &realm_id, &client_id).await
}
...
pub async fn delete_client_by_id(
    ...
    ClientApi::delete_client(&session, &realm_id, &client_id).await
}
...
pub async fn client_add_client_roles_mapping(
    ...
    ClientApi::add_client_role_mapping(&session, &realm_id, &client_id, &role_id).await
}
...
pub async fn client_remove_client_roles_mapping(
    ...
    ClientApi::remove_client_role_mapping(&session, &realm_id, &client_id, &role_id).await
}
...
pub async fn client_load_client_roles_mapping(
    ...
    ClientApi::load_client_roles_mapping(&session, &realm_id, &client_id).await
}
...
pub async fn client_add_client_scope_mapping(
    ...
    ClientApi::add_client_scope_mapping(&session, &realm_id, &client_id, &client_scope_id).await
}
...
pub async fn client_remove_client_scope_mapping(
    ...
    ClientApi::remove_client_scope_mapping(&session, &realm_id, &client_id, &client_scope_id).await
}
...
pub async fn client_load_client_scopes_by_client_id(
    ...
    ClientApi::load_client_scopes_by_client_id(&session, &realm_id, &client_id).await
}
...
pub async fn client_add_client_protocol_mapper(
    ...
    ClientApi::add_client_protocol_mapping(&session, &realm_id, &client_id, &mapper_id).await
}
...
pub async fn client_remove_client_protocol_mapper(
    ...
    ClientApi::remove_client_protocol_mapping(&session, &realm_id, &client_id, &mapper_id).await
}
...
pub async fn client_load_client_protocol_mappers(
    ...
    ClientApi::load_protocol_mappers_by_client_id(&session, &realm_id, &client_id).await
}
...
pub async fn client_load_associated_service_account(
    ...
    ClientApi::load_associated_service_acount_by_client_id(&session, &realm_id, &client_id).await
}
...
pub async fn create_client_scope(
    ...
    ClientApi::create_client_scope(&session, client_scope_model).await
}
...
pub async fn update_client_scope(
    ...
    ClientApi::update_client_scope(&session, client_scope_model).await
}
...
pub async fn client_scope_load_by_id(
    ...
    ClientApi::load_client_scope_by_scope_id(&session, &realm_id, &client_scope_id).await
}
...
pub async fn client_scope_delete_by_id(
    ...
    ClientApi::delete_client_scope(&session, &realm_id, &client_scope_id).await
}
...
pub async fn client_scope_add_protocol_mapper(
    ...
    ClientApi::add_client_scope_protocol_mapper(&session, &realm_id, &client_scope_id, &mapper_id)
        .await
}
...
pub async fn create_protocol_mapper(
    ...
    ClientApi::create_protocol_mapper(&session, mapper_model).await
}
...
pub async fn update_protocol_mapper(
    ...
    ClientApi::update_protocol_mapper(&session, mapper_model).await
}
...
pub async fn protocol_mapper_load_by_id(
    ...
    ClientApi::load_protocol_mapper_by_mapper_id(&session, &realm_id, &mapper_id).await
}
...
pub async fn protocol_mappers_delete_by_id(
    ...
    ClientApi::delete_protocol_mapper(&session, &realm_id, &mapper_id).await
}
...
pub async fn protocol_mappers_load_by_protocol(
    ...
    ClientApi::load_protocol_mapper_by_protocol(&session, &realm_id, &protocol).await
}
