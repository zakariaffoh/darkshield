...
pub async fn create_role(
    ...
    AuthorizationModelApi::create_role(&session, role_model).await
}
...
pub async fn update_role(
    ...
    AuthorizationModelApi::update_role(&session, role_model).await
}
...
pub async fn load_role_by_id(
    ...
    AuthorizationModelApi::load_role_by_id(&session, &realm_id, &role_id).await
}
...
pub async fn delete_role_by_id(
    ...
    AuthorizationModelApi::delete_role(&session, &realm_id, &role_id).await
}
...
pub async fn create_group(
    ...
    AuthorizationModelApi::create_group(&session, group_model).await
}
...
pub async fn update_group(
    ...
    AuthorizationModelApi::udpate_group(&session, group_model).await
}
...
pub async fn load_group_by_id(
    ...
    AuthorizationModelApi::load_group_by_id(&session, &realm_id, &group_id).await
}
...
pub async fn delete_group_by_id(
    ...
    AuthorizationModelApi::delete_group(&session, &realm_id, &group_id).await
}
...
pub async fn add_group_role(
    ...
    AuthorizationModelApi::add_group_role(&session, &realm_id, &group_id, &role_id).await
}
...
pub async fn remove_group_role(
    ...
    AuthorizationModelApi::remove_group_role(&session, &realm_id, &group_id, &role_id).await
}
...
pub async fn create_identity_provider(
    ...
    AuthorizationModelApi::create_identity_provider(&session, idp_model).await
}
...
pub async fn update_identity_provider(
    ...
    AuthorizationModelApi::udpate_identity_provider(&session, idp_model).await
}
...
pub async fn load_identity_provider(
    ...
    AuthorizationModelApi::load_identity_provider(&session, &realm_id, &internal_id).await
}
...
pub async fn load_identity_providers_by_realm(
    ...
    AuthorizationModelApi::load_identity_providers_by_realm(&session, &realm_id).await
}
...
pub async fn delete_identity_provider(
    ...
    AuthorizationModelApi::delete_identity_provider(&session, &realm_id, &internal_id).await
}
...
pub async fn create_resource_server(
    ...
    AuthorizationModelApi::create_resource_server(&session, resource_server_model).await
}
...
pub async fn update_resource_server(
    ...
    AuthorizationModelApi::udpate_resource_server(&session, resource_server_model).await
}
...
pub async fn load_resource_server(
    ...
    AuthorizationModelApi::load_resource_server_by_id(&session, &realm_id, &server_id).await
}
...
pub async fn delete_resource_server_by_id(
    ...
    AuthorizationModelApi::delete_resource_server_by_id(&session, &realm_id, &server_id).await
}
...
pub async fn create_resource(
    ...
    AuthorizationModelApi::create_resource(&session, resource_model).await
}
...
pub async fn update_resource(
    ...
    AuthorizationModelApi::udpate_resource(&session, resource_model).await
}
...
pub async fn load_resource(
    ...
    AuthorizationModelApi::load_resource_by_id(&session, &realm_id, &server_id, &resource_id).await
}
...
pub async fn load_resources_by_server(
    ...
    AuthorizationModelApi::load_resources_by_server(&session, &realm_id, &server_id).await
}
...
pub async fn delete_resource_by_id(
    ...
    AuthorizationModelApi::delete_resource_by_id(&session, &realm_id, &server_id, &resource_id)
        .await
}
...
pub async fn create_scope(
    ...
    AuthorizationModelApi::create_scope(&session, scope_model).await
}
...
pub async fn update_scope(
    ...
    AuthorizationModelApi::udpate_scope(&session, scope_model).await
}
...
pub async fn load_scope_by_id(
    ...
    AuthorizationModelApi::load_scope_by_id(&session, &realm_id, &server_id, &scope_id).await
}
...
pub async fn load_scope_by_realm_and_server(
    ...
    AuthorizationModelApi::load_scopes_by_realm(&session, &realm_id, &server_id).await
}
...
pub async fn delete_scope_by_id(
    ...
    AuthorizationModelApi::delete_scope_by_id(&session, &realm_id, &server_id, &scope_id).await
}
...
pub async fn create_policy(
    ...
    AuthorizationModelApi::create_policy(&session, &realm_id, &server_id, policy_model).await
}
...
pub async fn update_policy(
    ...
    AuthorizationModelApi::update_policy(&session, &realm_id, &server_id, &policy_id, policy_model)
        .await
}
...
pub async fn load_policy_by_id(
    ...
    AuthorizationModelApi::load_policy_by_id(&session, &realm_id, &server_id, &policy_id).await
}
...
pub async fn load_policy_scopes_by_policy_id(
    ...
    AuthorizationModelApi::load_policy_scopes_by_policy_id(
        &session, &realm_id, &server_id, &policy_id,
    )
    .await
}
...
pub async fn load_policies_by_server_id(
    ...
    AuthorizationModelApi::load_policies_by_server_id(&session, &realm_id, &server_id).await
}
...
pub async fn count_policies_by_query(
    ...
    AuthorizationModelApi::count_policies_by_query(&session, &realm_id, &count_query).await
}
...
pub async fn search_policies_by_query(
    ...
    AuthorizationModelApi::search_policies_by_query(&session, &realm_id, &search_query).await
}
...
pub async fn delete_policy_by_id(
    ...
    AuthorizationModelApi::delete_policy_by_id(&session, &realm_id, &server_id, &policy_id).await
}
